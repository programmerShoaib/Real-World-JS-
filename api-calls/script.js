document.addEventListener("DOMContentLoaded", () => {
    ...
    async function fetchProducts() {
        ...
        try {
            ...
            errorMessage.textContent = `Error: Failed to fetch products : ${error.message}`;
    ...
    function displayProducts(products) {
        products.forEach((product) => {
            ...
            productDiv.classList.add("w-full", "max-w-sm", "bg-white", "border", "border-gray-200", "p-4", "rounded-lg", "shadow-sm", "dark:bg-gray-800", "dark:border-gray-700");
            productDiv.innerHTML = `
                <a href="${product.url}" class="p-8 rounded">
